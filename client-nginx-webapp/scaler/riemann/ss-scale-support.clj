...
(defn cond-scale
  ...
  [metric-val comp]
  (cond
    (scale-up? metric-val comp) (put-scale-request :up comp)
    (scale-down? metric-val comp) (put-scale-request :down comp)))
